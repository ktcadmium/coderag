...
sleep 0.1
) | /Users/ken/dev/MCP/mcp-coderag/target/release/coderag-mcp 2>&1 | grep -v "Schema error:" | grep -E "(Received:|Sending:|INFO|WARN|ERROR|shutting down|Client disconnected)"
